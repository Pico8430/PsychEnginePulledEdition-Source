...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character (0 = BF, 1 = Dad, 2 = GF)\nValue 2: New character's name"],
		['Flash Screen', "Screen flashes entirely, that's basically it."],
